...
\title{Multimedia Retrieval Report 1}
\author{Saiyang Zhang, Siyi Liu, Zuchi Zheng}
...
This project is developed on Windows 10/11, python $\geq$ 3.6, with pymeshlab/tkinter/trimeshlab.
